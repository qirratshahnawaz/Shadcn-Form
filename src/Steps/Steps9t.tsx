...
export default function Step9t() {
  ...
  return (
    <div className="p-8 space-y-12">
      <div className="space-y-4 bg-muted p-6 rounded-lg shadow">
        <Label className="text-lg font-semibold">Unterhalten Sie Onlinepräsenzen in sozialen Medien, wie z. B. Facebook, Instagram, etc.?</Label>
